...
Project precipation `pr` under representative concentration pathway scenarios `rcp45` and `rcp85` for years `2006-2025` and `2036-2065`.
**To be redone with
...
Want to figure out how to use slider as in species project to display all 30 years or sum over years.

```{python}
#| label: fig-maca
maca_2010_year_da = maca_year(maca_da[0], 2010) # 0 = `rcp85`, 1 = `rcp45`
plot_gdf_da(buffalo_gdf, maca_2010_year_da)
```

```{python}
#| label: fig-maca
maca_2010_year_da = maca_year(maca_da[1], 2010) # 0 = `rcp85`, 1 = `rcp45`
plot_gdf_da(buffalo_gdf, maca_2010_year_da)
```
