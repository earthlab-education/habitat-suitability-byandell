...
maca_da_list = process_maca_list({'oglala': oglala_gdf}, ['pr'], ['rcp45'], (2011, 2040))
maca_da = (
...
This should be similar to Elsa's code to the `periods` list,
but I could not figure out how to work with this.
Instead, I pulled the da out of the df in code below,
which is part of code in my `maca_year` code.
...
```{python}
((precip_min_da > 330) & (precip_max_da < 700)).plot()
```
